...
export default function Footer() {
  return (
    <footer className="bg-[#0d233f] text-white py-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/desarrollo-web" className="text-gray-400 hover:text-white text-sm transition-colors">
              Desarrollo Web
            </Link>
            ...
            <Link to="/contacto" className="text-gray-400 hover:text-white text-sm transition-colors">
              Contacto
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a
              href="https://instagram.com/laugus.web"
              target="_blank"
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-3">
            <img src="/images/laugusico.jpg" alt="Laugus Logo" className="w-6 h-6 rounded-lg" />
            <span className="font-semibold" style={{ fontFamily: "var(--font-display)" }}>
              Laugus
            </span>
            <span className="text-gray-400 text-sm">— Soluciones web simples y efectivas</span>

...
export default function Footer() {
  return (
    <footer className="bg-[#0d233f] text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img src="/images/laugusico.jpg" alt="Laugus Logo" className="w-10 h-10 rounded-lg" />
              <h3 className="text-xl font-bold">Laugus</h3>
            </div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/desarrollo-web" className="text-gray-400 text-sm hover:text-[#06b6d4] transition-colors">
                Desarrollo Web
              </Link>
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-3 bg-[#25D366] text-white px-4 py-2 rounded-lg font-medium text-sm hover:bg-[#20bd5a] transition-colors"
            >

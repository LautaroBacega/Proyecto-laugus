...
export default function Home() {
  return (
    <div className="bg-[#f6fbff]">
      {/* Hero Section */}
      <section className="bg-[#0d233f] text-white py-20 md:py-32">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed" data-aos="fade-up" data-aos-delay="300">
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0d233f] text-center mb-4 hover-lift" data-aos="fade-up">
            Servicios
          </h2>
          <p className="text-[#475569] text-center mb-12 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 card-hover h-full"
                data-aos="fade-up"
                data-aos-delay={200 + index * 100}
              >
                <div
                  className="w-14 h-14 bg-[#06b6d4]/10 rounded-xl flex items-center justify-center mb-6 animate-float"
                  style={{ animationDelay: `${index * 200}ms` }}
                >
                  <service.icon className="w-7 h-7 text-[#06b6d4]" />
                </div>
                <h3 className="text-xl font-semibold text-[#0d233f] mb-3 hover-lift cursor-default">{service.title}</h3>
                <p className="text-[#475569] leading-relaxed mb-6">{service.description}</p>
                <Link
                  to={service.link}
                  className="inline-flex items-center gap-2 text-[#06b6d4] font-semibold hover:text-[#0891b2] transition-colors hover-underline"
                >
                  {service.cta}
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#f6fbff]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0d233f] mb-4 hover-lift" data-aos="fade-up">
            ¿Listo para empezar?
          </h2>
          <p className="text-[#475569] mb-8 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">

        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-[#f6fbff] p-6 rounded-2xl border border-gray-100 card-hover h-full flex flex-col"
                data-aos="zoom-in"
                data-aos-delay={200 + index * 100}
              >
                ...
                <p className="text-[#475569] text-sm leading-relaxed mb-4 font-light flex-grow">"{testimonial.text}"</p>

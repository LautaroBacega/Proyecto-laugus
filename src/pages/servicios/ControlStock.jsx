    ...
    <div className="bg-[#fafbfc]">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0d233f] via-[#0d233f] to-[#1a3a5f]">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center py-8 relative z-10">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center shadow-lg mx-auto mb-6 animate-zoom-in">
          ...
          <p
            className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent mb-4 opacity-0 animate-zoom-in-up"
          ...
          >
            Sistema web para gestionar tu inventario. Controlá entradas, salidas y recibí alertas de stock bajo.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8" data-aos="fade-up">
            <span className="inline-block px-4 py-1 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-sm font-semibold rounded-full mb-3">
              Incluido
            </span>
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center" data-aos="fade-up">
          ...
          <a
            href="https://wa.me/5491112345678?text=Hola!%20Me%20interesa%20un%20sistema%20de%20control%20de%20stock"
            target="_blank"

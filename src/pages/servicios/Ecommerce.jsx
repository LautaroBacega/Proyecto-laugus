...
const targetAudience = [
  { icon: Users, text: "Emprendedores que quieren vender sus productos online" },
  { icon: Briefcase, text: "Comercios que buscan expandir sus ventas al mundo digital" },
  { icon: ShoppingCart, text: "Marcas que necesitan una tienda propia sin comisiones" },
]

const designFeatures = [
  { icon: ShoppingCart, text: "Catálogo de productos ilimitado" },
  { icon: CreditCard, text: "Múltiples métodos de pago" },
  { icon: Truck, text: "Integración con envíos" },
  { icon: Smartphone, text: "Diseño 100% adaptable a celulares" },
]
...
const faqs = [
  {
    question: "¿Qué es una tienda E-commerce?",
    answer:
      "Es una tienda online propia donde podés vender tus productos, gestionar pedidos y cobrar de forma automática.",
  },
  {
  ...
  },
  {
    ...
    answer: "Sí, podés cargar todos los productos que quieras, con fotos, descripciones, variantes y precios.",
  },
  {
    question: "¿Qué métodos de pago acepta?",
    answer: "Mercado Pago, transferencia bancaria, efectivo y otros medios según tu preferencia.",
  },
  {
    question: "¿Incluye integración con envíos?",
    answer: "Sí, podemos integrar con Correo Argentino, Andreani, OCA o el servicio que prefieras.",
  },
  {
  ...
  {
    question: "¿Puedo gestionar el stock desde la tienda?",
    answer: "Sí, tenés un panel de administración para gestionar productos, stock, pedidos y clientes.",
  },
]
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 text-rose-500 flex-shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-[68%] space-y-6">
              <div data-aos="fade-right">
                <img
                  src="/ecommerce/ecommerceIMG.png"
              ...
              <div className="lg:hidden space-y-4">
                <div className="bg-gradient-to-br from-rose-500 to-orange-600 rounded-xl p-5 text-white text-center shadow-lg">
                  <p className="text-xs uppercase tracking-wider mb-1 opacity-80">Precio único</p>
                  <div className="text-3xl font-bold mb-1">Desde $375.000</div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-white text-rose-600 px-4 py-2.5 rounded-lg font-semibold text-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 w-full"
                  >
                ...
                <div className="space-y-1.5">
                  {targetAudience.map((item, index) => (
                    <div key={index} className="flex items-center gap-2 text-sm text-[#475569]">
                      <item.icon className="w-4 h-4 text-rose-500 flex-shrink-0" />
                      <span>{item.text}</span>
                    </div>
                  ))}
                </div>
              ...
              <div data-aos="fade-right" data-aos-delay="50">
                <h2 className="text-lg font-bold text-[#0d233f] font-display mb-2">¿Qué incluye la tienda?</h2>

...
const benefits = [
  {
    icon: Clock,
    title: "Ahorrá tiempo",
    description: "Sin llamadas ni mensajes para agendar.",
  },
  {
    icon: Bell,
    title: "Menos ausencias",
    description: "Recordatorios automáticos a clientes.",
  },
  {
    icon: Smartphone,
    title: "Siempre disponible",
    description: "Tus clientes reservan cuando quieran.",
  },
]
    ...
    <div className="bg-[#fafbfc]">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0d233f] via-[#0d233f] to-[#1a3a5f]">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center py-8 relative z-10">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center shadow-lg mx-auto mb-6 animate-zoom-in">
          ...
          >
            Página web con sistema de reservas online. Tus clientes sacan turnos y vos gestionás tu agenda desde un
            panel.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-3" data-aos="fade-up" data-aos-delay="100">
            {useCases.map((useCase, index) => (
              <span
                key={index}
                className="bg-gradient-to-r from-emerald-50 to-teal-50 text-[#0d233f] px-4 py-2 rounded-full border border-emerald-200 font-medium hover:bg-emerald-100 transition-colors"
              >
                {useCase}
              </span>
            ))}
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center" data-aos="fade-up">
          ...
          <p className="text-[#475569] mb-6 max-w-xl mx-auto">
            Contactanos y te ayudamos a digitalizar la gestión de tu agenda.
          </p>
          <a
            href="https://wa.me/5491112345678?text=Hola!%20Me%20interesa%20un%20sistema%20de%20turnos%20online"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
          >

...
const benefits = [
  {
    icon: Pencil,
    title: "Editá vos mismo",
    description: "Cambiá textos e imágenes sin ayuda.",
  },
  {
    icon: RefreshCw,
    title: "Actualización inmediata",
    description: "Cambios al instante, sin esperar.",
  },
  {
    icon: Settings,
    title: "Panel simple",
    description: "Interfaz fácil de usar.",
  },
]

const idealFor = [
  "Negocios con contenido cambiante",
    ...
    <div className="bg-[#fafbfc]">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0d233f] via-[#0d233f] to-[#1a3a5f]">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center py-8 relative z-10">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg mx-auto mb-6 animate-zoom-in">
          ...
          <p
            className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent mb-4 opacity-0 animate-zoom-in-up"
          ...
          >
            Editá textos, imágenes y contenido vos mismo sin depender del desarrollador.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14 bg-[#fafbfc]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8" data-aos="fade-up">
            <span className="inline-block px-4 py-1 bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-sm font-semibold rounded-full mb-3">
              Incluido
            </span>
      ...
      <section className="py-10 md:py-14 bg-[#fafbfc]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8" data-aos="fade-up">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[#0d233f] font-display">¿Por qué elegirla?</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4" data-aos="fade-up" data-aos-delay="100">
            {benefits.map((benefit, index) => (
              <div key={index} className="relative group">
                <div className="absolute -inset-[1px] bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl opacity-50 group-hover:opacity-100 transition-opacity duration-500 blur-sm"></div>
                <div className="relative bg-[#fafbfc] rounded-2xl p-5 border border-gray-100 text-center h-full">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg mx-auto mb-4">
      ...
      <section className="py-10 md:py-14 bg-[#fafbfc]">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8" data-aos="fade-up">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[#0d233f] font-display">¿Para quién es?</h2>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3" data-aos="fade-up" data-aos-delay="100">
            {idealFor.map((item, index) => (
              <span
                key={index}
                className="bg-gradient-to-r from-blue-50 to-indigo-50 text-[#0d233f] px-4 py-2 rounded-full border border-blue-200 font-medium hover:bg-blue-100 transition-colors"
              >
                {item}
              </span>
            ))}
      ...
      <section className="py-10 md:py-14 bg-[#fafbfc]">
        <div className="max-w-4xl mx-auto px-4 text-center" data-aos="fade-up">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0d233f] font-display mb-4">
            ¿Te interesa la Landing Autogestionable?
          </h2>
          <p className="text-[#475569] mb-6 max-w-xl mx-auto">
            Contactanos y tené control total sobre tu contenido web.
          </p>
          <a
            href="https://wa.me/5491112345678?text=Hola!%20Me%20interesa%20la%20Landing%20Autogestionable"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
          >
            ...
            Solicitar Landing Autogestionable
          </a>
        </div>
      </section>
    </div>

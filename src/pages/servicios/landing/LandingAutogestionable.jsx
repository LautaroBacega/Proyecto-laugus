            ...
            <div className="lg:w-[68%] space-y-6">
              ...
              <div className="lg:hidden space-y-4">
                ...
                <div className="bg-white rounded-xl p-5 text-center shadow-sm border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-500 ease-out">
                  ...
                  <div className="text-3xl font-bold mb-1 text-[#0d233f]">Desde $100.000</div>
                ...
                <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:border-gray-300 hover:bg-gray-50 transition-all duration-500 ease-out">

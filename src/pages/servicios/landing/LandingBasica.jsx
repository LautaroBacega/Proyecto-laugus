...
const designFeatures = [
  { icon: ImageIcon, text: "Hasta 6 imágenes de calidad o banners diseñados especialmente" },
...
const faqs = [
  ...
  {
    question: "¿Se puede agregar un formulario de contacto?",
    answer: "Sí, es opcional y muy útil si preferís recibir consultas por mail. Tiene costo adicional.",
  },
  {
    ...
    <div className="bg-[#fafbfc]">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0d233f] via-[#0d233f] to-[#1a3a5f]">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center py-8 relative z-10">
          ...
          <p
            className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed opacity-0 animate-zoom-in-up mb-6"
            style={{ fontFamily: "'Inter', sans-serif", animationDelay: "0.2s" }}
          >
            Elegí el modelo ideal para tu negocio y mirá ejemplos reales de landing pages con precios claros y
            resultados comprobados.
          </p>
          <p
            className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed opacity-0 animate-zoom-in-up mb-8"
            style={{ fontFamily: "'Inter', sans-serif", animationDelay: "0.3s" }}
          >
            Llevá tu marca al siguiente nivel con una página de presentación profesional y atractiva, pensada para
            captar la atención desde el primer vistazo y generar contacto directo con potenciales clientes.
          </p>

          {/* Price highlight */}
          <div className="opacity-0 animate-zoom-in-up" style={{ animationDelay: "0.4s" }}>
            <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2">
              $70.000 ARS
            </p>
            <p className="text-gray-400 text-sm mb-6">pago único</p>
            <p className="text-cyan-300 text-sm max-w-md mx-auto mb-8">
              Incluye hosting, dominio y certificado SSL gratis durante el primer año.
            </p>
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all duration-300 opacity-0 animate-zoom-in-up"

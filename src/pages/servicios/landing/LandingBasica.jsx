  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 text-cyan-500 flex-shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-[68%] space-y-6">
              ...
              <div className="lg:hidden space-y-4">
                {/* Precio */}
                <div className="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-xl p-5 text-white text-center shadow-lg">
                  <p className="text-xs uppercase tracking-wider mb-1 opacity-80">Precio único</p>
                  <div className="text-3xl font-bold mb-1">Desde $70.000</div>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-white text-cyan-600 px-4 py-2.5 rounded-lg font-semibold text-sm hover:shadow-md hover:scale-[1.02] transition-all duration-300 w-full"
                  >
                  ...
                  <div className="space-y-2">
                    {additionals.map((item, index) => (
                      <div key={index} className="flex items-center gap-2 text-sm">
                        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center flex-shrink-0">

...
import { Check, Globe, Monitor, Smartphone, Zap } from "lucide-react"
import BackButton from "../../../components/BackButton"

const features = [
  "Diseño personalizado responsive",
  "Desarrollo y configuración completa",
...
const benefits = [
  {
    ...
    description: "Página diseñada a medida para tu marca.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    icon: Zap,
    title: "Carga rápida",
    description: "Optimizada para velocidad.",
  },
]
    ...
    <div className="bg-[#fafbfc]">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#0d233f] via-[#0d233f] to-[#1a3a5f]">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center py-8 relative z-10">
          ...
          >
            Página web de una sola sección para presentar tu servicio o producto de forma clara y efectiva.
          </p>
        </div>
      </section>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="relative group">
                ...
                <div className="relative bg-[#fafbfc] rounded-2xl p-5 border border-gray-100 text-center h-full">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center shadow-lg mx-auto mb-4">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-3" data-aos="fade-up" data-aos-delay="100">
            {idealFor.map((item, index) => (
              <span
                key={index}
                className="bg-gradient-to-r from-cyan-50 to-blue-50 text-[#0d233f] px-4 py-2 rounded-full border border-cyan-200 font-medium hover:bg-cyan-100 transition-colors"
              >
                {item}
              </span>
            ))}
      ...
      <section className="py-10 md:py-14 bg-[#fafbfc]">
        <div className="max-w-4xl mx-auto px-4 text-center" data-aos="fade-up">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0d233f] font-display mb-4">
            ¿Te interesa la Landing Page Básica?
          </h2>
          <p className="text-[#475569] mb-6 max-w-xl mx-auto">
            Contactanos y empezá a tener presencia online profesional.
          </p>
          <a
            href="https://wa.me/5491112345678?text=Hola!%20Me%20interesa%20la%20Landing%20Page%20Básica"
            target="_blank"

...
const targetAudience = [
  ...
  { icon: Briefcase, text: "Empresas con múltiples servicios o productos que requieren páginas separadas" },
  { icon: User, text: "Profesionales que quieren una web más completa sin complejidad" },
]

const designFeatures = [
  { icon: Layout, text: "Todo lo incluido en Landing Base" },
  { icon: Navigation, text: "Pestañas adicionales ($20.000 c/u)" },
  { icon: ImageIcon, text: "Hasta 6 imágenes o banners por pestaña" },
  { icon: Link2, text: "Navegación entre secciones fluida" },
...
const faqs = [
  {
    question: "¿Qué es una landing con pestañas?",
    answer:
      "Es una landing page que incluye múltiples secciones o páginas internas navegables, ideal para mostrar más contenido de forma organizada.",
  },
  {
    question: "¿Cuántas pestañas puedo agregar?",
    answer: "Podés agregar las que necesites. Cada pestaña adicional tiene un costo de $20.000.",
  },
  {
    question: "¿Cuánto tarda en estar lista?",
    answer: "El tiempo promedio de entrega es de 5 a 7 días hábiles dependiendo de la cantidad de pestañas.",
  },
  {
  ...
  },
  {
    ...
    answer: "Sí, todo se personaliza según tu marca o preferencia. También podemos ayudarte a definirlo.",
  },
  {
  ...
  {
    question: "¿Qué pestañas son las más comunes?",
    answer: "Nosotros, Servicios, Contacto, Galería, Preguntas frecuentes, Blog, Testimonios y Equipo.",
  },
  {
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-[68%] space-y-6">
              ...
              <div data-aos="fade-right">
                <img
                  src="/landingpestanas/imglp.jpg"
                  alt="Landing Page con Pestañas"
